        ...
        plugin.getServer().getScheduler().runTaskAsynchronously(plugin, () -> {
            try {
                ...
                plugin.getServer().getScheduler().runTask(plugin, () -> {
                    ...
                    statusLore.add(ChatColor.GRAY + "現在時刻: " + ChatColor.WHITE + MinecraftServerController.getFormattedCurrentTime());
                    statusLore.add(ChatColor.GRAY + "Status: " + (status.status.toLowerCase().contains("up")
                            ? ChatColor.GREEN + "RUNNING" : ChatColor.RED + "STOPPED"));
                    statusLore.add(ChatColor.GRAY + "稼働時間: " + ChatColor.WHITE + plugin.getFormattedUptime());
                    ...
                    inv.setItem(49, createItem(Material.COMPASS,
                            ...
                            ChatColor.GRAY + "現在時刻: " + ChatColor.WHITE + MinecraftServerController.getFormattedCurrentTime(),
